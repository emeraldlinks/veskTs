...
> Comparison with Next.js (React), Qwik, and Astro.
...
| # | Feature | Vesk | Next.js | Qwik | Astro |
|---|---|---|---|---|---|
...
| # | Feature | Vesk | Next.js | Qwik | Astro |
|---|---|---|---|---|---|
| ★★★ | Client bundle size | ~30KB (min) | ~400KB (React + Next.js) | ~10KB (min, lazy-loaded) | ~0KB (zero JS by default) |
...
| ★★ | Plugin system | Custom hooks: onCSS, onFileWatch, onTransformJS, onBuildStart, onBuildEnd | Next.js Config | Vite plugins | Astro integrations |
...
| Metric | Vesk | Next.js | Qwik | Astro |
|---|---|---|---|---|
...
| Zero-JS page | ~0 KB | ~0 KB (static export) | ~0 KB | ~0 KB |
...
| Category | Vesk | Next.js | Qwik | Astro |
|---|---|---|---|---|
...
> *Note: Many Next.js/Qwik/Astro features come from the ecosystem (React, TypeScript, etc.) rather than framework-specific implementations. Vesk implements more from scratch due to being a standalone compiler+runtime. Next.js counts exclude React core features that aren't part of Next.js itself.*
