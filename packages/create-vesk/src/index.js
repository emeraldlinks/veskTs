...
writeFileSync(join(targetDir, 'package.json'), JSON.stringify({
	...
	dependencies: {
		...
		'@vesk/vesk-cli': '^0.2.4',
		'@vesk/adapter': '^0.2.4',
		'@vesk/plugin-tailwind': '^0.2.4',
	},
	optionalDependencies: {
		'@vesk/haul-darwin-arm64': '^0.2.4',
		'@vesk/haul-darwin-x64': '^0.2.4',
		'@vesk/haul-linux-arm64': '^0.2.4',
		'@vesk/haul-linux-x64': '^0.2.4',
		'@vesk/haul-win32-x64': '^0.2.4',
	},
	devDependencies: {
		tailwindcss: '^4.0.0',
		typescript: '^5.8.0',
