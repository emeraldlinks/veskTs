...
export function VeskParserPlugin(config = {}) {
    return (Parser) => {
        ...
        class VeskParser extends Parser {
            ...
            checkUnreserved(ref) {
                if (ref.name === 'component') {
                    this.raise(ref.start, '`component` is a reserved keyword and cannot be used as an identifier');
                }
