...
function findRuntimeSrc(appDir) {
    ...
    if (existsSync(monorepoRuntime))
        return monorepoRuntime;
...
function buildMainBundle(routeTree, runtimeDir, codeSplit, mono, hmr, importRuntime) {
    ...
    if (codeSplit) {
        ...
        const startRouterCode = 'const __startRouter = function() {\n' +
            ...
            '  __startRouter();\n' +
            '}\n';
        const runtimeGlobals = 'globalThis.reactiveProps = reactiveProps;\n' +
